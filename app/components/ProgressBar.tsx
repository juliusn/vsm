...
export function ProgressBarAnchor({
  href,
  children,
  ...rest
}: ComponentProps<typeof Anchor> & { href: string; children: ReactNode }) {
  const progress = useProgressBar();
  const router = useRouter();
...
export function ProgressBarNavLink({
  href,
  children,
  ...rest
}: ComponentProps<typeof NavLink> & { href: string; children: ReactNode }) {
  const progress = useProgressBar();
  const router = useRouter();
